...
Pod::Spec.new do |s|
  ...
  s.name         = "CustomDisplayController"
  s.version      = "0.0.1"
  s.summary      = "CustomDisplayController."
  ...
  s.description  = <<-DESC
                    this is CustomDisplayController
                   DESC
  ...
  s.source       = { :git => "https://github.com/simplecomponent/CustomDisplayController.git", :tag => s.version.to_s }
